    ...
    <div class="custom-card card">
        <div class="card-header p-3 border-bottom-small">
            ...
            <form class="multiple-select-delete-form d-none"
                action="{{ route('admin.uploads.guests.destroy.selected') }}" method="POST">
                @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="vironeer-content-box">
                                            ...
                                            <div>
                                                <a class="text-reset"
                                                    href="{{ route('admin.uploads.guests.view', $fileEntry->shared_id) }}">{{ shortertext($fileEntry->name, 50) }}</a>
